...
from VIFB_metrics.metricsEntropy import metrics_entropy
print('<!-- a_VIFB_metrics_EN -->')
...
for method in methods:
    ...
    for img_name in image_names:
        ...
        result_EN += metrics_entropy(img1, img2, fused)

    result_EN = result_EN / len(image_names)    
    print(method + ': ' + str(np.round(result_EN, 3)))
