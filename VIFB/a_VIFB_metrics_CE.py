...
from VIFB_metrics.metricsCross_entropy import metrics_cross_entropy
print('<!-- a_VIFB_metrics_CE -->')
...
for method in methods:
    ...
    for img_name in image_names:
        ...
        result_CE += metrics_cross_entropy(img1, img2, fused)

    result_CE = result_CE / len(image_names)    
    print(method + ': ' + str(np.round(result_CE, 3)))
