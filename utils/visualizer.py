        ...
        if segments_info is None:
            ...
            for panoptic_label in np.unique(panoptic_seg.numpy()):
                if panoptic_label == -1:
                    # VOID region.
                    continue
                pred_class = torch.div(panoptic_label, label_divisor, rounding_mode="floor")
...
class Visualizer:
    ...
    def __init__(self, img_rgb, metadata=None, scale=1.0, instance_mode=ColorMode.IMAGE):
        ...
        self._default_font_size = max(
            np.floor_divide(np.sqrt(self.output.height * self.output.width), 90),
            np.floor_divide(10, scale)
        )
        # self._default_font_size = 18
        self._default_font_size = 27
    ...
    def draw_panoptic_seg(self, panoptic_seg, segments_info, area_threshold=None, alpha=0.7):
        ...
        Args:
            ...
            segments_info (list[dict] or None): Describe each segment in `panoptic_seg`.
                ...
                ``torch.div(pixel, metadata, rounding_mode="floor").label_divisor``.
    ...
    def draw_polygon(self, segment, color, edge_color=None, alpha=0.5):
        ...
        polygon = mpl.patches.Polygon(
            ...
            edgecolor=edge_color,
            linewidth = max(torch.div(self._default_font_size, 15 * self.output.scale, rounding_mode='floor').item(), 1)
